            ...
            <div class="left-container">
                    ...
                    <div class="box-border mb-3">
                        <div class="row px-2 fs-10">
                            ...
                            <div class="row mb-2 pe-0">
                                <div class="col-sm-6">
                                    <input type="text" id="guestName" name="guestName" class="form-control" value="${rsrv.guestName}" disabled>
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" id="guestPhoneNumber" name="guestPhoneNumber" class="form-control" value="${rsrv.guestPhoneNumber}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2 pe-0">
                                <div class="col-sm-6">
                                    <input type="text" id="guestEmail" name="guestEmail" class="form-control" value="${rsrv.guestEmail}" disabled>
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" id="residenceCountry" name="residenceCountry" class="form-control" value="${rsrv.residenceCountry}" disabled>
                                </div>
                            </div>
                    ...
                    <div class="box-border mb-3">
                        <div class="row px-2 mb-3 fs-10">
                            ...
                            <div class="row mb-2">
                                ${rsrv.reservationRequests}
                                <!-- 여기 확인!!!!! 조회가 안됨! -->

                                <c:forEach varStatus="reservationRequestStatus" var="reservationRequest" items="${rsrv.reservationRequests}">
                                    <div class="col-sm-6 mb-2">
                                        <input class="form-check-input" type="checkbox" name="specialRequests[]" id="reservationRequest_${reservationRequestsStatus.index}" value="${reservationRequest.requestNo}">
                                        <label class="form-check-label" for="reservationRequest_${reservationRequestStatus.index}">${reservationRequest.requestName}</label>
                                    </div>
                                </c:forEach>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div>
                                    <textarea id="reservationDetailsRequest" name="reservationDetailsRequest"
                                              class="py-2 box-border" disabled rows="3">${rsrv.reservationDetailsRequest}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
