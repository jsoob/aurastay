        ...
        <div>
            <div class="form-group">
                ...
                <div class="checkbox-group">
                    <c:forEach var="category" items="${categories}">e
                        <label><input type="radio" name="categoryNo"
            ...
            <div>
                <button id="showr"> <%--juery를 사용하여 modal창으로 보여주기--%>
                <h3>객실 정보</h3>
                <label>객실명</label>
                ...
                <label>View Type</label>    <%--ViewType => 0: 오션뷰, 1: 마운틴뷰, 2: 시티뷰--%>
